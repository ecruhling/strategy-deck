...
namespace Strategy_Deck\Integrations\Widgets;
...
class My_Recent_Posts_Widget extends \WPH_Widget {
	...
	public function __construct() { // phpcs:ignore
		$args = array(
			'label'       => \__( 'My Recent Posts Example', SD_TEXTDOMAIN ),
			'description' => \__( 'My Recent Posts Widget Description', SD_TEXTDOMAIN ),
			'slug'        => 'recent-posts',
		...
		$args[ 'fields' ] = array(
			...
			array(
				// Field name/label
				'name'     => \__( 'Title', SD_TEXTDOMAIN ),
				// Field description
				'desc'     => \__( 'Enter the widget title.', SD_TEXTDOMAIN ),
				// Field id
				'id'       => 'title',
				...
				'class'    => 'widefat',
				// Default value
				'std'      => \__( 'Recent Posts', SD_TEXTDOMAIN ),
				/**
			...
			// Taxonomy Field
			array(
				'name'  => \__( 'Taxonomy', SD_TEXTDOMAIN ),
				'desc'  => \__( 'Set the taxonomy.', SD_TEXTDOMAIN ),
				'id'    => 'taxonomy',
				'type'  => 'taxonomy',
				'class' => 'widefat',
			),
			// Taxonomy Field
			array(
				'name'     => \__( 'Taxonomy terms', SD_TEXTDOMAIN ),
				'desc'     => \__( 'Set the taxonomy terms.', SD_TEXTDOMAIN ),
				'id'       => 'taxonomyterm',
				'type'     => 'taxonomyterm',
				'taxonomy' => 'category',
				'class'    => 'widefat',
			...
			// Pages Field
			array(
				'name'  => \__( 'Pages', SD_TEXTDOMAIN ),
				'desc'  => \__( 'Set the page.', SD_TEXTDOMAIN ),
				'id'    => 'pages',
				'type'  => 'pages',
				'class' => 'widefat',
			),
			// Post type Field
			array(
				'name'     => \__( 'Post type', SD_TEXTDOMAIN ),
				'desc'     => \__( 'Set the post type.', SD_TEXTDOMAIN ),
				'id'       => 'posttype',
				'type'     => 'posttype',
				'posttype' => 'post',
				'class'    => 'widefat',
			...
			// Amount Field
			array(
				'name'     => \__( 'Amount', SD_TEXTDOMAIN ),
				'desc'     => \__( 'Select how many posts to show.', SD_TEXTDOMAIN ),
				'id'       => 'amount',
				'type'     => 'select',
				// Selectbox fields
				'fields'   => array(
					array(
						'name'  => \__( '1 Post', SD_TEXTDOMAIN ),
						'value' => '1',
					),
					array(
						'name'  => \__( '2 Posts', SD_TEXTDOMAIN ),
						'value' => '2',
					),
					array(
						'name'  => \__( '3 Posts', SD_TEXTDOMAIN ),
						'value' => '3',
					),
			...
			array(
				'name'   => \__( 'Output as list', SD_TEXTDOMAIN ),
				'desc'   => \__( 'Wraps posts with the <li> tag.', SD_TEXTDOMAIN ),
				'id'     => 'list',
				'type'   => 'checkbox',
				// Checked by default:
				'std'    => 1, // 0 or 1
	...
	public function initialize() {
		...
		'widgets_init',
		static function() {
			\register_widget( 'Strategy_Deck\Integrations\Widgets\My_Recent_Posts_Widget' );
		}
		);
	}
